...
* 기본 권장 (Java 17+) : [JMXer.jar](https://github.com/cool8519/JMXer/releases/download/v1.1.0/JMXer.jar)
* 레거시 호환 (Java 8+) : [JMXer-java8.jar](https://github.com/cool8519/JMXer/releases/download/v1.1.0/JMXer-java8.jar)
